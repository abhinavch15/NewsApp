...
public class FeedAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView author = (TextView)convertView.findViewById(R.id.bleee);
        ...
        viewholder.author.setText(currentapp.getAuthor());

        randomshit(currentapp.getAuthor());
    ...
    private class Viewholder{
        ...
        Viewholder(View v){
            this.tvname=(TextView)v.findViewById(R.id.textView4);
            this.author=(TextView)v.findViewById(R.id.bleee);
